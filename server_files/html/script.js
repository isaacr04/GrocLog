...
async function loadItems() {
    const response = await fetch("/itemlog/search", {
        method: "POST",
...
async function addItem(event) {
    ...
    const response = await fetch("/itemlog/add", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
...
async function deleteItem(entry) {
    const response = await fetch("/itemlog/delete", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
...
async function editItem(entry) {
    ...
    if (newItem && newPrice && newDate) {
        const response = await fetch("/itemlog/edit", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
